...
namespace WindowsApiApp
{
    ...
    public static class DesktopArt
    {
        ...
        public static void Run(Sample s) {
            ...
            if (s == Sample.Desert)
                bmp = new Bitmap(Properties.Resources.desert);
            else if (s == Sample.FamilyGuy)
                bmp = new Bitmap(Properties.Resources.fam);
            else if (s == Sample.Mountains)
                bmp = new Bitmap(Properties.Resources.mountains);
            else if (s == Sample.Shotgun)
                bmp = new Bitmap(Properties.Resources.shotgun);
            else if (s == Sample.Tree)
                bmp = new Bitmap(Properties.Resources.tree);
        ...
        private static void GetInput() {
            ...
            string path = null;
            while (!validPath) {
                MessageBox.Show("Drag in a bitmap or type in the full path name: ");
                path = Microsoft.VisualBasic.Interaction.InputBox("Drag in a bitmap or type in the full path name: ", "Title", " ");
