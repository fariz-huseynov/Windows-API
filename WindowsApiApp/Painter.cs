    ...
    class Painter
    {
        ...
        public static void Run() {
            ...
            if (!Window.DoesExist("Untitled - Paint")) {
                System.Windows.Forms.MessageBox.Show("Microsoft Paint Window with the name \"Untitled - Paint\" not found.");
                return;
            }

            hWnd = Window.Get("Untitled - Paint");
            Bitmap bitmap = Properties.Resources.istanbul2;
            ...
            for (int y = 0; y < bmp.Height; y++) {
                for (int x = 0; x < bmp.Width; x++) {
                    ...
                    if (Window.IsFocused(hWnd) == false)
                        return;
